...
public final class UpdateUserHandler implements OperationHandler {
  ...
  @Override
  public void handle() {
    // VIOLACIÓN Regla 4: abreviaturas en nombres de variables ("password" y "upd").
    ...
    try {
      final UserResponse updateUserResponse = userController.updateUser(
      ...
      printer.print(updateUserResponse);
